/* -*- linux-c -*- */
/* $Id: producer.c,v 1.1 2015/03/04 12:00:03 korpe Exp korpe $ */
...
main(int argc, char **argv) {
    ...
    while (1) {
        ...
        while ((sdata_ptr->in + 1) % BUFFER_SIZE == sdata_ptr->out); // buffer is full - wait in a busy loop
